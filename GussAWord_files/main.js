...
let letterWord;
let levelsArray = [
  {word:"FRANCE",hint:"HINT:   Romance",picQ: "It tastes better than it looks" ,herf: "./pictureproject/eclair.jpeg",winmoto: "You won! take a bite!", losemoto:"You lost! sorry, we're fresh out"},
  { word:"SEASHELL",hint:"HINT:   Ssshhhh...",picQ: "Swim with dolphins?" ,herf: "./pictureproject/dolphin.jpeg",winmoto: "You won! The swimsuit is our treat", losemoto:"You lost! Stay dry"},
  { word:"BEACH",hint:"HINT:   Near the sea",picQ:"Wanna go there?" ,herf: "./pictureproject/bora-bora.jpeg",winmoto:  "You won! Have you packed alone?", losemoto:"You lost! The food was really great"},
  { word:"SNORKEL",hint:"HINT:   Blending with the fish?",picQ: "Wanna go cruising?" ,herf: "./pictureproject/boat.jpeg",winmoto: "You won! Anchor away!", losemoto:"You lost! Captain Stuving sends his regard"},
  {word:"FINGERS",hint:"HINT:   Typo",picQ: "Treasure hunting??" ,herf: "./pictureproject/treasure.jpeg",winmoto: "You won! Don't forget us", losemoto:"You lost! sorry, X didn't mark the spot"},
  {word:"HAMMOCK",hint:"HINT:   Nothing but net",picQ: "Looking for a place to crash?" ,herf: "./pictureproject/house.jpeg",winmoto: "You won! party time!", losemoto:"You lost! Sorry, you've missed it!"},
  {word:"UMBRELA",hint:"HINT:   Don't Repeat Yourself",picQ: "Dessert?" ,herf: "./pictureproject/ice dessert.jpeg",winmoto: "You won! yammmy!", losemoto:"You lost! sorry, next costumer please"},
  {word:"CELLPHONE",hint:"HINT:   Check your pockets",picQ: "Looking for a new boss?" ,herf: "./pictureproject/nice boss.jpeg",winmoto: "You won! We've hired Elon Musk", losemoto:"You lost! sorry, we hired Mr. Bean "},
];
